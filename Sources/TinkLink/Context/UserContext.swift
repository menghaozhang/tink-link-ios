...
public final class UserContext {
    ...
    public init(tinkLink: Link = .shared) {
    ...
    @discardableResult
    public func createTemporaryUser(for market: Market, locale: Locale = Link.defaultLocale, completion: @escaping (Result<User, Error>) -> Void) -> RetryCancellable? {
