...
extension TinkLink.Scope {
    public struct Access: OptionSet, Hashable {
        ...
        public static let read = TinkLink.Scope.Access(rawValue: 1 << 0)
        public static let write = TinkLink.Scope.Access(rawValue: 1 << 1)
        public static let grant = TinkLink.Scope.Access(rawValue: 1 << 2)
        public static let revoke = TinkLink.Scope.Access(rawValue: 1 << 3)
        public static let refresh = TinkLink.Scope.Access(rawValue: 1 << 4)
        public static let categorize = TinkLink.Scope.Access(rawValue: 1 << 5)
        public static let execute = TinkLink.Scope.Access(rawValue: 1 << 6)
        public static let create = TinkLink.Scope.Access(rawValue: 1 << 7)
        public static let delete = TinkLink.Scope.Access(rawValue: 1 << 8)
        public static let webHooks = TinkLink.Scope.Access(rawValue: 1 << 9)
