...
final class CredentialService: TokenConfigurableService {
    ...
    func credentials(completion: @escaping (Result<[Credential], Error>) -> Void) -> Handleable {
    ...
    func createCredential(providerName: Identifier<Provider>, type: Credential.`Type` = .unknown, fields: [String: String] = [:], completion: @escaping (Result<Credential, Error>) -> Void) -> Handleable {
    ...
    func deleteCredential(credentialID: Identifier<Credential>, completion: @escaping (Result<Void, Error>) -> Void) -> Handleable {
    ...
    func updateCredential(credentialID: Identifier<Credential>, fields: [String: String] = [:], completion: @escaping (Result<Credential, Error>) -> Void) -> Handleable {
    ...
    func refreshCredentials(credentialIDs: [Identifier<Credential>], completion: @escaping (Result<Void, Error>) -> Void) -> Handleable {
    ...
    func supplementInformation(credentialID: Identifier<Credential>, fields: [String: String] = [:], completion: @escaping (Result<Void, Error>) -> Void) -> Handleable {
    ...
    func cancelSupplementInformation(credentialID: Identifier<Credential>, completion: @escaping (Result<Void, Error>) -> Void) -> Handleable {
    ...
    func enableCredential(credentialID: Identifier<Credential>, completion: @escaping (Result<Void, Error>) -> Void) -> Handleable {
    ...
    func disableCredential(credentialID: Identifier<Credential>, completion: @escaping (Result<Void, Error>) -> Void) -> Handleable {
    ...
    func thirdPartyCallback(state: String, parameters: [String: String], completion: @escaping (Result<Void, Error>) -> Void) -> Handleable {
    ...
    func manualAuthentication(credentialID: Identifier<Credential>, completion: @escaping (Result<Void, Error>) -> Void) -> Handleable {
