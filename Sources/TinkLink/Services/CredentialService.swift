...
final class CredentialService: TokenConfigurableService {
    ...
    func credentials(completion: @escaping (Result<[Credential], Error>) -> Void) -> (Cancellable & Retriable) {
    ...
    func createCredential(providerName: Identifier<Provider>, type: Credential.`Type` = .unknown, fields: [String: String] = [:], completion: @escaping (Result<Credential, Error>) -> Void) -> (Cancellable & Retriable) {
    ...
    func deleteCredential(credentialID: Identifier<Credential>, completion: @escaping (Result<Void, Error>) -> Void) -> (Cancellable & Retriable) {
    ...
    func updateCredential(credentialID: Identifier<Credential>, fields: [String: String] = [:], completion: @escaping (Result<Credential, Error>) -> Void) -> (Cancellable & Retriable) {
    ...
    func refreshCredentials(credentialIDs: [Identifier<Credential>], completion: @escaping (Result<Void, Error>) -> Void) -> (Cancellable & Retriable) {
    ...
    func supplementInformation(credentialID: Identifier<Credential>, fields: [String: String] = [:], completion: @escaping (Result<Void, Error>) -> Void) -> (Cancellable & Retriable) {
    ...
    func cancelSupplementInformation(credentialID: Identifier<Credential>, completion: @escaping (Result<Void, Error>) -> Void) -> (Cancellable & Retriable) {
    ...
    func enableCredential(credentialID: Identifier<Credential>, completion: @escaping (Result<Void, Error>) -> Void) -> (Cancellable & Retriable) {
    ...
    func disableCredential(credentialID: Identifier<Credential>, completion: @escaping (Result<Void, Error>) -> Void) -> (Cancellable & Retriable) {
    ...
    func thirdPartyCallback(state: String, parameters: [String: String], completion: @escaping (Result<Void, Error>) -> Void) -> (Cancellable & Retriable) {
    ...
    func manualAuthentication(credentialID: Identifier<Credential>, completion: @escaping (Result<Void, Error>) -> Void) -> (Cancellable & Retriable) {
