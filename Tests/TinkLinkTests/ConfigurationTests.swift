...
class ConfigurationTests: XCTestCase {
    func testConfiguration() {
        ...
        let configuration = try! TinkLink.Configuration(clientID: "abc", redirectURI: redirectURI)
    ...
    func testConfigureWithoutRedirectURLHost() {
        ...
        do {
            let _ = try TinkLink.Configuration(clientID: "abc", redirectURI: redirectURI)
